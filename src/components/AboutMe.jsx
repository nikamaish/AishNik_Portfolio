...
>
      <motion.div
        ...
        className="relative w-72 h-72 md:w-[400px] md:h-[400px] rounded-full overflow-hidden shadow-[0_0_40px_#06b6d4]"
      >
        <img
          src={Aish}
          alt="Aishwarya Nikam"
      ...
      >
        <h2 className="text-6xl font-bold mb-6 bg-gradient-to-r from-[#9333ea] to-[#06b6d4] bg-clip-text text-transparent">
          About Me
        </h2>
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="mt-8 inline-block px-6 py-3 bg-gradient-to-r from-[#9333ea] to-[#06b6d4] text-white font-semibold rounded-full shadow-[0_0_20px_#06b6d4] hover:shadow-[0_0_30px_#9333ea] transition-all duration-300"
        >
          View My Work
        </motion.a>
      </motion.div>
